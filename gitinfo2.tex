...
or any other particular item of metadata,
it will normally set the metadata to a default common value, ``(None)''.
You can change this value to something else with, say
\texttt{missing=\{What a mess\}} or \texttt{missing=Help!}.

If you have complex needs, as in the first example,
...
For additional information, the use of these options is described in more detail in
...
at \href{http://www.latex-project.org/lppl.txt}{The \LaTeX\ Project},
